package rush;
import Chow5.DeliveryDrone;
import Chow5.DesignSchool;
import Chow5.FulfillmentCenter;
import Chow5.HQ;
import Chow5.Landscaper;
import Chow5.Miner;
import Chow5.NetGun;
import Chow5.Refinery;
import Chow5.Vaporator;
...
public strictfp class RobotPlayer {
    ...
    static final int UNIQUEKEY = -123799469;
    ...
    public static void run(RobotController rc) throws GameActionException {
        ...
        // run setup code
        switch (rc.getType()) {
            case HQ:                 Chow5.HQ.setup();                break;
            case MINER:              Chow5.Miner.setup();             break;
            case REFINERY:           Chow5.Refinery.setup();          break;
            case VAPORATOR:          Chow5.Vaporator.setup();         break;
            case DESIGN_SCHOOL:      DesignSchool.setup();      break;
            case FULFILLMENT_CENTER: FulfillmentCenter.setup(); break;
            case LANDSCAPER:         Chow5.Landscaper.setup();        break;
            case DELIVERY_DRONE:     DeliveryDrone.setup();     break;
            case NET_GUN:            Chow5.NetGun.setup();            break;
        }
        while (true) {
            turnCount += 1;
