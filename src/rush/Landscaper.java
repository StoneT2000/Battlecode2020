...
public class Landscaper extends RobotPlayer {
    ...
    public static void run() throws GameActionException {
        ...
        for (int i = 0; i < Chow5.Constants.BFSDeltas24.length; i++) {
            int[] deltas = Chow5.Constants.BFSDeltas24[i];
        ...
        if (role == ATTACK) {
            ...
            if (!onSupportBlockDoNotMove) {
                for (int i = Chow5.Constants.FirstLandscaperPosAroundHQ.length; --i >= 0; ) {
                    int[] deltas = Chow5.Constants.FirstLandscaperPosAroundHQ[i];
            ...
            if (closestBuildLoc == null) {
                for (int i = Chow5.Constants.LandscaperPosAroundHQ.length; --i >= 0; ) {
                    int [] deltas = Chow5.Constants.LandscaperPosAroundHQ[i];
                    MapLocation checkLoc = HQLocation.translate(deltas[0], deltas[1]);
                    int dist = rc.getLocation().distanceSquaredTo(checkLoc);
    ...
    static Direction getDigDirectionForDefending() throws GameActionException {
        for (int i = Chow5.Constants.DigDeltasAroundHQ.length; --i >= 0; ) {
            int[] deltas = Chow5.Constants.DigDeltasAroundHQ[i];
            MapLocation checkLoc = HQLocation.translate(deltas[0], deltas[1]);
